...
function content_5f27ea5621cbc5_49062527 (Smarty_Internal_Template $_smarty_tpl) {
...
" class="dropdown-item pointer">
                        ...
                        <!-- Delete -->
                        <!-- Hide -->
                        <?php if ((!$_smarty_tpl->tpl_vars['_post']->value['in_group'] && !$_smarty_tpl->tpl_vars['_post']->value['in_event'])) {?>
...
<?php if ($_smarty_tpl->tpl_vars['_post']->value['post_type'] == "album" || ($_smarty_tpl->tpl_vars['_post']->value['post_type'] == "product" && $_smarty_tpl->tpl_vars['_post']->value['photos_num'] > 0) || $_smarty_tpl->tpl_vars['_post']->value['post_type'] == "photos" || $_smarty_tpl->tpl_vars['_post']->value['post_type'] == "profile_picture" || $_smarty_tpl->tpl_vars['_post']->value['post_type'] == "profile_cover" || $_smarty_tpl->tpl_vars['_post']->value['post_type'] == "page_picture" || $_smarty_tpl->tpl_vars['_post']->value['post_type'] == "page_cover" || $_smarty_tpl->tpl_vars['_post']->value['post_type'] == "group_picture" || $_smarty_tpl->tpl_vars['_post']->value['post_type'] == "group_cover" || $_smarty_tpl->tpl_vars['_post']->value['post_type'] == "event_cover") {?>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="float:left;background-color:white;">
...
}?>" class="js_fluidplayer" <?php if ($_smarty_tpl->tpl_vars['user']->value->_logged_in) {?>onplay="update_media_views('video', <?php echo $_smarty_tpl->tpl_vars['_post']->value['video']['video_id'];?>
...
<!-- post text -->
<?php if ($_smarty_tpl->tpl_vars['_post']->value['post_type'] == "product") {?>
<div class="post col-lg-6 col-md-6 col-sm-12 col-xs-12" style="float:left;">
<?php } else { ?>
...
echo $_smarty_tpl->tpl_vars['_post']->value['product']['price'];?>
 (<?php echo $_smarty_tpl->tpl_vars['system']->value['system_currency'];?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['_post']->value['author_id'] != $_smarty_tpl->tpl_vars['user']->value->_data['user_id']) {?>
        <div class="mt10 clearfix" style="margin-bottom:25px;">
            <button class="btn btn-sm btn-danger" id="pay-button"><?php echo __("Buy");?>
</button>
...
<?php echo '<script'; ?>
 src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="SB-Mid-client-kSnLJ45nSegi7XpJ"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 type="text/javascript">
  document.getElementById('pay-button').onclick = function(){
    ...
    {
      transaction_details: {
        gross_amount: <?php echo $_smarty_tpl->tpl_vars['_post']->value['product']['price'];?>
,
  ...
  function getSnapToken(requestBody, callback) {
    ...
    xmlHttp.open("post", "https://teachin.id/checkout.php");
