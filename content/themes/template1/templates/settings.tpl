            ...
            <div class="card">
                <div class="card-body with-nav">
                    <ul class="side-nav">
                        ...
                        {if !$user->_is_company}
                        <li {if $view == "cv"}class="active"{/if}>
                                <a href="{$system['system_url']}/settings/cv">
        ...
        <div class="col-md-8 col-lg-9 offcanvas-mainbar">
            <div class="card">
                    ...
                    {if $sub_view == ""}
                        <div class="card-header with-icon">
                            ...
                            <div class="float-right">
                                <a target="_blank" href="{if !$user->_is_company}{$system['system_url']}/{else}{$system['system_url']}/institution/{/if}{$user->_data['user_name']}" class="btn btn-sm btn-info">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label class="form-control-label">{if !$user->_is_company}{__("First Name")}{else}{__("Institution Name")}{/if}</label>
                                ...
                                {/if}
                                <div class="form-group">
                                    <label class="form-control-label">{if !$user->_is_company}{__("About Me")}{else}{__("Overview")}{/if}</label>
                        ...
                        <form class="js_ajax-forms " data-url="users/settings.php?edit=location">
                            <div class="card-body">
                                ...
                                <div class="form-group" style="display:none;">
                                    ...
                                    <input type="text" class="form-control js_geocomplete" id="latitude" name="lat" value="{$user->_data['user_latitude']}">
                                </div>
                                
                                <div class="form-group" style="display:none;">
                                    <label class="form-control-label">{__("Longitude")}</label>
                                    <input type="text" class="form-control js_geocomplete" id="longitude" name="lng" value="{$user->_data['user_longitude']}">
                                </div>                                
                ...
                {elseif $view == "apps"}
                 ...
                 {elseif $view == "cv"}
                    <div class="card-header with-icon">
                        <i class="fa fa-id-card fa-fw mr10" style="color: #f44336;"></i>{__("Curriculum Vitae")}
                    </div>
                                ...
                                <ul class="row">
                                        <li class="col-md-6">
                                            <div class="publisher-tools-tab attach js_publisher-tab" data-tab="file">
                                                <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/publisher/folder.png" class="js_x-uploader" data-handle="cv"  data-type="file">{__("Upload File")}
                                            </div>
                                        </li>
                                </ul>
            ...
            <div class="mt10"> <a class="btn btn-primary btn-sm" href="{$system['system_uploads']}/{$cv['user_cv']}">View</a> </div> </div> </div>
                        </div>
                        {/if}
                     {/foreach}
                                        </div>
