...
{else}
    <body data-hash-tok="{$session_hash['token']}" data-hash-pos="{$session_hash['position']}" data-chat-enabled="{$user->_data['user_chat_enabled']}" class="{if $system['theme_mode_night']}night-mode{/if} {if $user->_is_company}n_chat{/if}{if $system['activation_enabled'] && !$user->_data['user_activated']} n_activated{/if}{if !$user->_cv} n_activated{/if}{if !$system['system_live']} n_live{/if}" {if $page == 'profile' && $system['system_profile_background_enabled'] && $profile['user_profile_background']}style="background: url({$profile['user_profile_background']}) fixed !important; background-size: 100% auto;"{/if} {if $page == "share" && $url}onload="initialize_scraper()"{/if}>
{/if}
        ...
        <div class="top-bar">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        <a class="text-link"  href="{$system['system_url']}/settings/cv">Upload CV</a>
                    </div> 
                </div>
            </div>
    </div>
                            ...
                            <div class="col-md-5 col-lg-4">
                                ...
                                <div class="navbar-wrapper">
                                    <ul class="clearfix">
                                        ...
                                        {else}
                                                    <a class="dropdown-item" href="{$system['system_url']}/institution/{$user->_data['user_name']}">{__("Profile")}</a>
                                        {/if}
                                        ...
                                        {else}
                                            ...
                                            <li class="dropdown float-right">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item" href="{$system['system_url']}/signup_company">{__("Register Company")}</a>
