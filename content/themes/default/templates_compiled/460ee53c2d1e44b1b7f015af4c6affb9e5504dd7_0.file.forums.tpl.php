<?php
/* Smarty version 3.1.36, created on 2021-05-05 15:02:05
  from '/home/u6574599/public_html/content/themes/default/templates/forums.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_6092b36d28f0b5_83506371',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '460ee53c2d1e44b1b7f015af4c6affb9e5504dd7' => 
    array (
      0 => '/home/u6574599/public_html/content/themes/default/templates/forums.tpl',
      1 => 1616470924,
      2 => 'file',
    ),
  ),
...
function content_6092b36d28f0b5_83506371 (Smarty_Internal_Template $_smarty_tpl) {
...
/images/headers/undraw_elements_cipa.svg">
    ...
    <div class="inner">
        ...
        <p><?php echo __("The great place to discuss topics with other users");?>
</p>
    </div>
</div>
<!-- page header -->
...
?>
        ...
        <!-- content panel -->
        <div class="col-8 <?php if ($_smarty_tpl->tpl_vars['user']->value->_logged_in) {?>offcanvas-mainbar<?php }?>">
            <!-- tabs -->
            <div class="content-tabs rounded-sm shadow-sm clearfix">
                <ul>
                    <li <?php if ($_smarty_tpl->tpl_vars['view']->value == '') {?>class="active"<?php }?>>
                        <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/forums"><i class="fa fa-home mr5"></i><?php echo __("Home");?>
</a>
                    </li>
                    <li <?php if ($_smarty_tpl->tpl_vars['view']->value == "my-threads") {?>class="active"<?php }?>>
                        <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/forums/my-threads"><i class="fa fa-copy mr5"></i><?php echo __("My Threads");?>
</a>
                    </li>
                    <li <?php if ($_smarty_tpl->tpl_vars['view']->value == "my-replies") {?>class="active"<?php }?>>
                        <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/forums/my-replies"><i class="fa fa-comments mr5"></i><?php echo __("My Replies");?>
</a>
                    </li>
                    <li <?php if ($_smarty_tpl->tpl_vars['view']->value == "search") {?>class="active"<?php }?>>
                        <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/forums/search"><i class="fa fa-search mr5"></i><?php echo __("Search");?>
</a>
                    </li>
                </ul>
            </div>
...
<span class="badge badge-lg badge-light ml5"><?php echo number_format(count($_smarty_tpl->tpl_vars['online_users']->value),0);?>
</span>
                        </div>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                    <?php }?>
                    <li class="breadcrumb-item active"><?php echo $_smarty_tpl->tpl_vars['forum']->value['forum_name'];?>
</li>
                </ol>
                <!-- breadcrumb -->
...
' class="btn btn-sm btn-light btn-icon btn-rounded js_report" data-handle="forum_thread" data-id="<?php echo $_smarty_tpl->tpl_vars['thread']->value['thread_id'];?>
">
...
">
                                            ...
                                            <?php } else { ?>
                                                <button data-toggle="tooltip" data-placement="top" title='<?php echo __("Report");?>
' class="btn btn-sm btn-light btn-icon btn-rounded js_report" data-handle="forum_reply" data-id="<?php echo $_smarty_tpl->tpl_vars['reply']->value['reply_id'];?>
">
                                                    <i class="fa fa-flag fa-fw"></i>
                                                </button>
                                            <?php }?>
...
"><?php echo $_smarty_tpl->tpl_vars['forum']->value['forum_name'];?>
                ...
                <div class="card mt20">
                    <div class="card-header with-icon">
                        <i class="fa fa-edit pr5 mr10"></i><?php echo __("Write New Thread");?>
...
"><?php echo $_smarty_tpl->tpl_vars['thread']->value['title'];?>
                ...
                <div class="card mt20">
                    <div class="card-header with-icon">
                        <i class="fa fa-edit mr10"></i><?php echo __("Edit Thread");?>
...
<span class="badge badge-lg badge-light ml5"><?php if ($_smarty_tpl->tpl_vars['total']->value) {
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                    ...
                    <?php } else { ?>
                        ...
                        <div class="text-center text-muted mt20">
                            <i class="fa fa-copy fa-4x"></i>
                            <p class="mt10"><?php echo __("No results found");?>
</p>
                        </div>
                        <!-- no threads -->
                    <?php }?>
