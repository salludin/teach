<?php
/* Smarty version 3.1.36, created on 2021-05-06 01:43:49
  from '/home/u6574599/public_html/content/themes/default/templates/ads.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_609349d52d9d55_56104236',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '864ce452826388a3806264930cabfdd7ebe77628' => 
    array (
      0 => '/home/u6574599/public_html/content/themes/default/templates/ads.tpl',
      1 => 1620265427,
      2 => 'file',
    ),
  ),
...
function content_609349d52d9d55_56104236 (Smarty_Internal_Template $_smarty_tpl) {
...
/images/headers/undraw_growth_analytics_8btt.svg">
        ...
        <div class="inner">
            ...
            <p class="text-xlg"><?php echo __("Manage Ads, Create new Campaign and Access your Wallet");?>
</p>
        </div>
    <?php }?>
</div>
...
' href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/ads/views/<?php echo $_smarty_tpl->tpl_vars['campaign']->value['campaign_id'];?>
...
echo number_format($_smarty_tpl->tpl_vars['user']->value->_data['user_wallet_balance'],2);?>
                            ...
                            <div class="col-md-7">
                                ...
                                <?php }?>
                                <?php if (($_smarty_tpl->tpl_vars['system']->value['affiliates_enabled'] && $_smarty_tpl->tpl_vars['system']->value['affiliates_money_transfer_enabled']) && ($_smarty_tpl->tpl_vars['system']->value['points_enabled'] && $_smarty_tpl->tpl_vars['system']->value['points_money_transfer_enabled'])) {?>
                                    <div class="form-row">
                                ...
                                <?php } elseif (($_smarty_tpl->tpl_vars['system']->value['affiliates_enabled'] && $_smarty_tpl->tpl_vars['system']->value['affiliates_money_transfer_enabled'])) {?>
                                    <div class="row">
...
/images/no_results.png">
                ...
                <!-- wallet -->
            <?php } elseif ($_smarty_tpl->tpl_vars['view']->value == "views") {?>

                <!-- view -->
                <div class="card mt20">
                    <div class="card-header with-icon">
                        
                        <i class="fa fa-chart-line mr10"></i><?php echo __("View");?>
                                ...
                                <table class="table table-striped table-bordered table-hover js_dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo __("Views");?>
</th>
                                            <th><?php echo __("Clicks");?>
</th>
                                            <th><?php echo __("Males");?>
</th>
                                            <th><?php echo __("Females");?>
</th>
                                            <th><?php echo __("Date");?>
</th>
                                        </tr>
...
?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $_smarty_tpl->tpl_vars['campaign']->value['views'];?>

                                                </td>
                                                <td><?php echo $_smarty_tpl->tpl_vars['campaign']->value['clicks'];?>
</td>
                                                <td><?php echo $_smarty_tpl->tpl_vars['campaign']->value['male'];?>
</td>
                                                <td><?php echo $_smarty_tpl->tpl_vars['campaign']->value['female'];?>
</td>
                                                <td><?php echo $_smarty_tpl->tpl_vars['campaign']->value['date'];?>
</td>
