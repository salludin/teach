...
/* Smarty version 3.1.36, created on 2021-05-05 07:26:26
  from '/home/u6574599/public_html/content/themes/default/templates/__feeds_post.body.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_609248a2bd1270_36268381',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'dd0135fa3f7cd9276049aa1c43d27cfc5610bfe2' => 
    array (
      0 => '/home/u6574599/public_html/content/themes/default/templates/__feeds_post.body.tpl',
      1 => 1604468702,
      2 => 'file',
    ),
  ),
  ...
  array (
    ...
    'file:__feeds_post.text.tpl' => 4,
    'file:__feeds_post.body.tpl' => 2,
  ),
),false)) {
function content_609248a2bd1270_36268381 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/home/u6574599/public_html/includes/libs/Smarty/plugins/modifier.date_format.php','function'=>'smarty_modifier_date_format',),1=>array('file'=>'/home/u6574599/public_html/includes/libs/Smarty/plugins/modifier.truncate.php','function'=>'smarty_modifier_truncate',),));
?>
<!-- post header -->
...
<!-- post text -->
<?php if ($_smarty_tpl->tpl_vars['_post']->value['post_type'] != "product" && $_smarty_tpl->tpl_vars['_post']->value['post_type'] != "offer" && $_smarty_tpl->tpl_vars['_post']->value['post_type'] != "job") {?>
...
/posts/<?php echo $_smarty_tpl->tpl_vars['_post']->value['post_id'];?>
" target="_blank">
                <div class="image" style="background-image:url('<?php echo $_smarty_tpl->tpl_vars['_post']->value['job']['cover_image'];?>
');padding-top:100%"></div>
                <?php if ($_smarty_tpl->tpl_vars['_post']->value['job']['hide_salary'] == '1') {?>
                <?php } else { ?>
                <div class="source">
                    <strong><?php echo $_smarty_tpl->tpl_vars['system']->value['system_currency_symbol'];
echo $_smarty_tpl->tpl_vars['_post']->value['job']['salary_minimum'];?>
 - <?php echo $_smarty_tpl->tpl_vars['system']->value['system_currency_symbol'];
echo $_smarty_tpl->tpl_vars['_post']->value['job']['salary_maximum'];?>
...
" <?php if ($_smarty_tpl->tpl_vars['_post']->value['job']['candidates_count'] == 0) {?>disabled<?php }?>>
 ...
 (<?php echo $_smarty_tpl->tpl_vars['_post']->value['job']['candidates_count'];?>
            ...
            <?php }?>
            <?php if ($_smarty_tpl->tpl_vars['_post']->value['job']['available'] && $_smarty_tpl->tpl_vars['_post']->value['author_id'] != $_smarty_tpl->tpl_vars['user']->value->_data['user_id']) {?>
                <div class="mt10 clearfix">
...
<?php } elseif ($_smarty_tpl->tpl_vars['_post']->value['post_type'] == "video" && $_smarty_tpl->tpl_vars['_post']->value['video']) {?>
    <div class="overflow-hidden">
        <video class="js_videojs video-js vjs-fluid vjs-default-skin" id="video-<?php echo $_smarty_tpl->tpl_vars['_post']->value['video']['video_id'];
if ($_smarty_tpl->tpl_vars['pinned']->value || $_smarty_tpl->tpl_vars['boosted']->value) {?>-<?php echo $_smarty_tpl->tpl_vars['_post']->value['post_id'];
