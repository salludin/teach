                        ...
                        {if $sub_view == ""}
                            <div class="alert alert-primary">
                                ...
                                <div class="text">
                                    ...
                                    <br>
                                    {__("Your daily points limit is")} <strong><span class="badge badge-pill badge-warning">{if $system['packages_enabled'] && $user->_data['user_subscribed']}{$system['points_limit_pro']}{else}{$system['points_limit_user']}{/if}</span></strong> {__("Points")}, {__("You have")} <strong><span class="badge badge-pill badge-danger">{$remaining_points}</span></strong> {__("remaining points")}
                                    <br>
                                    {__("Your daily points limit will be reset after 24 hours from your last valid earned action (post, comment, reaction)")}
                                    <br>
                                    {if $system['points_money_withdraw_enabled']}
                                        {__("You can withdraw your money")}
                                    {/if}
