...
<div class="page-header">
    ...
    {else}
        ...
        <div class="inner">
            ...
            <p class="text-xlg">{__("Manage Ads, Create new Campaign and Access your Wallet")}</p>
        </div>
    {/if}
</div>
<!-- page header -->
                                        ...
                                        {foreach $campaigns as $campaign}
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a data-toggle="tooltip" data-placement="top" title='{__("View")}' href="{$system['system_url']}/ads/views/{$campaign['campaign_id']}" class="btn btn-sm btn-icon btn-rounded btn-success">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                    {if $campaign['campaign_is_active']}
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                ...
                                {/if}
                                {if ($system['affiliates_enabled'] && $system['affiliates_money_transfer_enabled']) && ($system['points_enabled'] && $system['points_money_transfer_enabled'])}
                                    <div class="form-row">
                                ...
                                {elseif ($system['affiliates_enabled'] && $system['affiliates_money_transfer_enabled'])}
                                    <div class="row">
            ...
            {elseif $view == "views"}
                ...
                <div class="card mt20">
                    <div class="card-header with-icon">
                        ...
                        <i class="fa fa-chart-line mr10"></i>{__("View")}
                    </div>
                    <div class="card-body">
                        {if $campaigns}
                            <div class="table-responsive">
