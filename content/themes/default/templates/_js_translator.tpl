...
{__("Going Live")}
{__("You are live now")}
{__("Going live failed")}
{__("Switching stream sources")}
{__("Successfully switched to new device")}
{__("Unable to determine device type")}
{__("Failed to switch to new device")}
{__("Ending live error")}
{__("Joining live stream failed")}
{__("Live Ended")}
<!-- /_js_files.tpl -->
...
{__("Processing...")}
{__("Search:")}
{__("Show _MENU_ entries")}
{__("Showing _START_ to _END_ of _TOTAL_ entries")}
{__("Showing 0 to 0 of 0 entries")}
{__("(filtered from _MAX_ total entries)")}
{__("Loading...")}
{__("No matching records found")}
{__("No data available in table")}
{__("First")}
{__("Previous")}
{__("Next")}
{__("Last")}
{__(": activate to sort column ascending")}
{__(": activate to sort column descending")}
<!-- /_js_files.tpl (DataTables) -->

<!-- _js_files.tpl (OneSignal) -->
{__("Subscribe to notifications")}
{__("You are subscribed to notifications")}
{__("You have blocked notifications")}
{__("Click to subscribe to notifications")}
{__("Thanks for subscribing!")}
{__("You are subscribed to notifications")}
{__("You will not receive notifications again")}
{__("Manage Site Notifications")}
{__("SUBSCRIBE")}
{__("UNSUBSCRIBE")}
{__("Unblock Notifications")}
...
{__("Write a comment")}
{__("Shared with: Public")}
{__("Shared with: Friends")}
{__("Shared with: Only Me")}
{__("Custom People")}
{__("Write a Reply")}
{__("Write a message")}
{__("Pro User")}
{__("Facebook Profile URL")}
{__("Twitter Profile URL")}
{__("Google+ Profile URL")}
{__("YouTube Profile URL")}
{__("Instagram Profile URL")}
...
{__("Appears on the right panel of home page")}
{__("Appears on the right panel of search page")}
{__("Appears on the right panel of discover people page")}
{__("Appears on the right panel of notifications page")}
{__("Appears on the right panel of post page")}
{__("Appears on the right panel of photo page")}
{__("Appears on the right panel of directory")}
{__("Appears on the top of products list")}
{__("Appears after")}
{__("posts are loaded, between the posts")}
