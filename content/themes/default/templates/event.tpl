            ...
            <div class="row">
                ...
                {if $view == ""}
                                ...
                                <ul class="about-list">
                                    ...
                                    <li>
                                        ...
                                        {if $custom_field['value']}
                                            ...
                                            {else}
                                            <a class="btn btn-sm btn-success d-none d-lg-block" data-toggle="modal" data-url="#buy-event">
                                            Rp. {number_format($custom_field['value'])}
                                            </a>
                                            {/if}
                                        {else}
                    ...
                    <div class="order-1 col-lg-5 order-lg-1">
                        ...
                        <!-- full-cover -->
                        <img class="js_lightbox" style="min-height: 391px;" data-init-position="{$event['event_cover_position']}" data-id="{$event['event_cover_id']}" data-image="{$event['event_cover_full']}" data-context="album" src="{$event['event_cover']}" alt="{$event['event_title']}" >
                        <!-- full-cover -->
