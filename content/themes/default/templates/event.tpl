            ...
            <div class="row">
                ...
                {if $view == ""}
                    ...
                    <div class="order-1 col-lg-5 order-lg-1">
                        ...
                        <!-- full-cover -->
                        <img class="js_position-cover-full js_lightbox" data-id="{$event['event_cover_id']}" data-image="{$event['event_cover_full']}" data-context="album" src="{$event['event_cover']}" alt="{$event['event_title']}" style="min-height: 366px;">
                        <!-- full-cover -->
