<div class="job-candidate-wrapper">
    <div class="job-candidate-header">
        ...
        <div class="job-candidate-info">
            ...
            <div>
                <!-- message -->
                <button type="button" class="btn btn-sm btn-primary rounded-pill js_chat-start" data-uid="{$candidate['user_id']}" data-name="{$candidate['user_firstname']} {$candidate['user_lastname']}" data-link="{$candidate['user_name']}">
