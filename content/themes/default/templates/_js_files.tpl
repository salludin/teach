...
{if $system['language']['dir'] == "LTR"}
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js" integrity="sha384-B4gt1jrGC7Jh4AgTPSdUtOBvfO8shuf57BaghqFfPlYxofvL8/KUEfYiJOMMV+rV" crossorigin="anonymous" {if !$user->_logged_in}defer{/if}></script>
{else}
...
<script src="{$system['system_url']}/includes/assets/js/plugins/mustache/mustache.min.js"></script> 
...
{if $user->_logged_in}
    ...
    <!-- TinyMCE -->
    {if $page == "admin" || $page == "blogs" || $page == "forums" || $page == "create_event"}
...
{if $user->_logged_in}
    ...
    {if $system['live_enabled'] && $page == "live"}
        <script src="{$system['system_url']}/includes/assets/js/sngine/live.js"></script>
    {/if}
{/if}
<!-- Sngine [JS] -->
