                ...
                <div class="form-group form-row">
                    ...
                    <div class="col-md-9">
                        <select class="form-control selectpicker" name="place">
                            ...
                            <option {if $data['place'] == "market"}selected{/if} value="market" data-content="<div class='option'><div class='icon'><i class='fa fa-shopping-bag fa-fw fa-lg'></i></div><div class='text'><b>{__("Marketplace")}</b><br>{__("Appears on the top of products list")}.
                            </div></div>">{__("Marketplace")}</option>

                            <option {if $data['place'] == "offers"}selected{/if} value="offers" data-content="<div class='option'><div class='icon'><i class='fa fa-tag fa-fw fa-lg'></i></div><div class='text'><b>{__("Offers")}</b><br>{__("Appears on the top of offers list")}.
                            </div></div>">{__("Jobs")}</option>

                            <option {if $data['place'] == "jobs"}selected{/if} value="jobs" data-content="<div class='option'><div class='icon'><i class='fa fa-briefcase fa-fw fa-lg'></i></div><div class='text'><b>{__("Jobs")}</b><br>{__("Appears on the top of jobs list")}.
                            </div></div>">{__("Jobs")}</option>
                ...
                <div class="form-group form-row">
                    ...
                    <div class="col-md-9">
                        <select class="form-control selectpicker" name="place">
                            ...
                            <option value="market" data-content="<div class='option'><div class='icon'><i class='fa fa-shopping-bag fa-fw fa-lg'></i></div><div class='text'><b>{__("Marketplace")}</b><br>{__("Appears on the top of products list")}.
                            </div></div>">{__("Marketplace")}</option>

                            <option value="offers" data-content="<div class='option'><div class='icon'><i class='fa fa-tag fa-fw fa-lg'></i></div><div class='text'><b>{__("Offers")}</b><br>{__("Appears on the top of offers list")}.
                            </div></div>">{__("Offers")}</option>

                            <option value="jobs" data-content="<div class='option'><div class='icon'><i class='fa fa-briefcase fa-fw fa-lg'></i></div><div class='text'><b>{__("jobs")}</b><br>{__("Appears on the top of jobs list")}.
                            </div></div>">{__("Jobs")}</option>
