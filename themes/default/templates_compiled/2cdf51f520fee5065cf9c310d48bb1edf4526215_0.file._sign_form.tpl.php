...
/* Smarty version 3.1.36, created on 2021-05-05 07:28:56
  from '/home/u6574599/public_html/content/themes/default/templates/_sign_form.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_609249386dbf81_81630046',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2cdf51f520fee5065cf9c310d48bb1edf4526215' => 
    array (
      0 => '/home/u6574599/public_html/content/themes/default/templates/_sign_form.tpl',
      1 => 1604649589,
      2 => 'file',
    ),
  ),
...
function content_609249386dbf81_81630046 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="card card-register" style="border-radius:25px;">
...
' name="username_email" required>
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="password" class="form-control" placeholder='<?php echo __("Kata sandi");?>
' name="password" required>
                    </div>
                </div>
                <div class="custom-control custom-checkbox mb10">
                    <input type="checkbox" class="custom-control-input" name="remember" id="remember">
                    <label class="custom-control-label" for="remember"><?php echo __("Ingatkan saya");?>
</label>
                    <a class="float-right" href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/reset"><?php echo __("Lupa sandi?");?>
</a>
                </div>
                <div class="form-group">
                    <button type="submit" class="btn btn-block btn-primary bg-gradient-blue border-0 rounded-pill"><?php echo __("Masuk");?>
</button>
                </div>
                <!-- error -->
...
/connect/vkontakte" class="btn btn-sm btn-rounded btn-social-icon btn-vk">
            ...
            <?php if ($_smarty_tpl->tpl_vars['system']->value['registration_enabled'] || (!$_smarty_tpl->tpl_vars['system']->value['registration_enabled'] && $_smarty_tpl->tpl_vars['system']->value['invitation_enabled'])) {?>
                <div class="mt20 text-center">
                    <?php echo __("Belum mendaftar?");?>
 <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/signup" class="js_toggle-panel text-link"><?php echo __("Buat akun");?>
</a>
                </div>
            <?php }?>
        </div>
...
' required>
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input name="first_name" type="text" class="form-control" placeholder='<?php echo __("Nama Depan");?>
' required>
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input name="last_name" type="text" class="form-control" placeholder='<?php echo __("Nama Belakang");?>
' required>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input name="password" type="password" class="form-control" placeholder='<?php echo __("Kata Sandi");?>
' required>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <select name="gender" id="gender" class="form-control" required>
                                <option value="none"><?php echo __("Pilih Jenis Kelamin");?>
:</option>
                                <option value="male"><?php echo __("Laki-Laki");?>
</option>
                                <option value="female"><?php echo __("Perempuan");?>
</option>
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['system']->value['age_restriction']) {?>
                        <div class="form-group">
                            <label class="form-control-label"><?php echo __("Tanggal Lahir");?>
</label>
                            <div class="form-row">
                                <div class="col">
                                    <select class="form-control" name="birth_month">
                                        <option value="none"><?php echo __("Bulan");?>
</option>
                                ...
                                <div class="col">
                                    <select class="form-control" name="birth_day">
                                        <option value="none"><?php echo __("Tanggal");?>
</option>
                                        <?php
...
?>
                                ...
                                <div class="col">
                                    <select class="form-control" name="birth_year">
                                        <option value="none"><?php echo __("Tahun");?>
</option>
                                        <?php
...
/static/privacy" target="_blank"><?php echo __("Privacy Policy");?>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-block btn-success bg-gradient-green border-0 rounded-pill"><?php echo __("Daftar");?>
</button>
                </div>
                <!-- error -->
                <div class="alert alert-danger mb0 x-hidden"></div>
...
/connect/vkontakte" class="btn btn-sm btn-rounded btn-social-icon btn-vk">
            ...
            <?php }?>
            <div class="mt20 text-center">
                <?php echo __("Sudah mendaftar?");?>
 <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/signin" class="js_toggle-panel text-link"><?php echo __("Masuk Sekarang");?>
</a>
            </div>
        </div>
    </div>
