        ...
        <div class="col-12 {if $user->_logged_in}offcanvas-mainbar{/if}">
            ...
            <div class="profile-header">
                ...
                <div class="profile-name-wrapper">
                    <a href="{$system['system_url']}/institution/{$profile['user_name']}">{$profile['user_firstname']} {$profile['user_lastname']}</a>
                ...
                <div class="profile-tabs-wrapper custom-scrollbar">
                    <ul>
                        <li>
                            <a href="{$system['system_url']}/institution/{$profile['user_name']}" {if $view == ""}class="active"{/if}>
                                <i class="fa fa-newspaper fa-fw mr5"></i>{__("Timeline")}
                            </a>
                        </li>
                        <li>
                            <a href="{$system['system_url']}/institution/{$profile['user_name']}/jobs" {if $view == "jobs"}class="active"{/if}>
                                <i class="fa fa-briefcase  fa-fw mr5"></i>{__("Job Posting")}
                            </a>
                        </li>
                        <li>
                            <a href="{$system['system_url']}/institution/{$profile['user_name']}/photos" {if $view == "photos" || $view == "albums" || $view == "album"}class="active"{/if}>
                                <i class="fa fa-images fa-fw mr5"></i>{__("Photos")}
                            </a>
                        </li>
                        <li>
                            <a href="{$system['system_url']}/institution/{$profile['user_name']}/videos" {if $view == "videos"}class="active"{/if}>
            ...
            <div class="row">
                ...
                {if $view == ""}
                                    ...
                                    <div class="mb5">
                                        {if !$profile['user_biography']}
                                            <a href="{$system['system_url']}/settings/profile">
                                                <i class="fas fa-plus-circle mr5"></i>{__("Add your overview")}
                                            </a>
                                        {else}
                                            <i class="fas fa-check-circle green mr5"></i>
                                            <span style="text-decoration: line-through;">{__("Add your overview")}</span>
                                        {/if}
                                    </div>
                                    <div class="mb5">
                                        {if !$profile['user_website']}
                                            <a href="{$system['system_url']}/settings/profile">
                                                <i class="fas fa-plus-circle mr5"></i>{__("Add your website")}
                                            </a>
                                        {else}
                                            <i class="fas fa-check-circle green mr5"></i>
                                            <span style="text-decoration: line-through;">{__("Add your website")}</span>
                                        {/if}
                                    </div>
                                    <div class="mb5">
                                        {if !$profile['user_address'] || !$profile['postal_code'] || !$profile['user_current_city']}
                    ...
                    <div class="order-2 col-lg-3 order-lg-3">
                        ...
                        {if $profile['photos']}
                            <div class="card panel-photos">
                                <div class="card-header bg-transparent">
                                    ...
                                    <strong><a href="{$system['system_url']}/institution/{$profile['user_name']}/photos">{__("Photos")}</a></strong>
                                </div>
                        ...
                        {if $profile['friends_count'] > 0}
                            <div class="card">
                                <div class="card-header bg-transparent">
                                    ...
                                    <strong><a href="{$system['system_url']}/institution/{$profile['user_name']}/friends">{__("Friends")}</a></strong>
                        ...
                        {if count($profile['pages']) > 0}
                            <div class="card">
                                <div class="card-header bg-transparent">
                                    ...
                                    <strong><a href="{$system['system_url']}/institution/{$profile['user_name']}/likes">{__("Likes")}</a></strong>
                                </div>
                                <div class="card-body ptb10 plr10">
                                    <div class="row no-gutters">
                        ...
                        {if count($profile['groups']) > 0}
                            <div class="card">
                                <div class="card-header bg-transparent">
                                    <i class="fa fa-users mr5"></i>
                                    <strong><a href="{$system['system_url']}/institution/{$profile['user_name']}/groups">{__("Groups")}</a></strong>
                                </div>
                                <div class="card-body ptb10 plr10">
                                    <div class="row no-gutters">
                        ...
                        {if count($profile['events']) > 0}
                            <div class="card">
                                <div class="card-header bg-transparent">
                                    ...
                                    <strong><a href="{$system['system_url']}/institution/{$profile['user_name']}/events">{__("Events")}</a></strong>
                                </div>
                                <div class="card-body ptb10 plr10">
                                    <div class="row no-gutters">
                    ...
                    <!-- center panel -->
                    <div class="order-3 {if $user->_data['user_id'] == $profile['user_id']}col-lg-6{else}col-lg-9{/if} order-lg-2">
                        <!-- panel [about] -->
                        <div class="card">
                            <div class="card-body">
                                {if !is_empty($profile['user_biography'])}
                                    <div class="about-bio">
                                        <div class="js_readmore overflow-hidden" style="text-align:justify;">
                                ...
                                <ul class="about-list">
                                    ...
                                    <li>
                                        <div class="about-list-item">
                                                <i class="fa fa-industry fa-fw fa-lg"></i>
                                                {$profile['id_industry']}
                                        </div>
                                    </li>
                        ...
                        <div class="card panel-photos">
                            <div class="card-header with-icon with-nav">
                                ...
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="{$system['system_url']}/institution/{$profile['user_name']}/photos">{__("Photos")}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{$system['system_url']}/institution/{$profile['user_name']}/albums">{__("Albums")}</a>
                                    </li>
                                </ul>
                                <!-- panel nav -->
                            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header with-icon with-nav">
                                ...
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{$system['system_url']}/institution/{$profile['user_name']}/photos">{__("Photos")}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link active" href="{$system['system_url']}/institution/{$profile['user_name']}/albums">{__("Albums")}</a>
                                    </li>
                                </ul>
                                <!-- panel nav -->
                            </div>
                    ...
                    <div class="col-12">
                        <div class="card panel-photos">
                            <div class="card-header with-icon with-nav">
                                <!-- back to albums -->
                                <div class="float-right">
                                    <a href="{$system['system_url']}/institution/{$profile['user_name']}/albums" class="btn btn-sm btn-light">
