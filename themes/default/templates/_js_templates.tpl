...
<script id="translator" type="text/template">
    <div class="modal-header">
        <h6 class="modal-title"><i class="fas fa-globe-americas mr5"></i>{__("Select Your Language")}</h6>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
    </div>
    ...
    {if $system['daytime_msg_enabled'] && $page == "index"}
        <script id="message-morning" type="text/template">
            <div class="card daytime_message">
                ...
                <div class="d-table-cell">
                    <strong>{__("Good Morning")}, {$user->_data['user_firstname']}</strong><br>
        ...
        <script id="message-afternoon" type="text/template">
            <div class="card daytime_message">
                ...
                <div class="d-table-cell">
                    <strong>{__("Good Afternoon")}, {$user->_data['user_firstname']}</strong><br>
        ...
        <script id="message-evening" type="text/template">
            <div class="card daytime_message">
                ...
                <div class="d-table-cell">
                    <strong>{__("Good Evening")}, {$user->_data['user_firstname']}</strong><br>
