                        ...
                        <div class="form-group form-row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control selectpicker" name="pages_permission">
                                    <option value="admins" {if $system['pages_permission'] == "admins"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-lock fa-lg fa-fw'></i></div><div class='text'><b>{__("Admins")}</b><br>{__("Only Admins and Moderators")}</div></div>">{__("Admins")}</option>
                                    <option value="pro" {if $system['pages_permission'] == "pro"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-rocket fa-lg fa-fw'></i></div><div class='text'><b>{__("Pro Users")}</b><br>{__("Only Admins, Moderators and Pro Users")}</div></div>">{__("Pro Users")}</option>
                                    <option value="verified" {if $system['pages_permission'] == "verified"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-check-circle fa-lg fa-fw'></i></div><div class='text'><b>{__("Verified Users")}</b><br>{__("Only Admins, Moderators, Pro and Verified Users")}</div></div>">{__("Verified Users")}</option>
                                    <option value="everyone" {if $system['pages_permission'] == "everyone"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-globe fa-lg fa-fw'></i></div><div class='text'><b>{__("Everyone")}</b><br>{__("Any user in the system can")}</div></div>">{__("Everyone")}</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control selectpicker" name="groups_permission">
                                    <option value="admins" {if $system['groups_permission'] == "admins"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-lock fa-lg fa-fw'></i></div><div class='text'><b>{__("Admins")}</b><br>{__("Only Admins and Moderators")}</div></div>">{__("Admins")}</option>
                                    <option value="pro" {if $system['groups_permission'] == "pro"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-rocket fa-lg fa-fw'></i></div><div class='text'><b>{__("Pro Users")}</b><br>{__("Only Admins, Moderators and Pro Users")}</div></div>">{__("Pro Users")}</option>
                                    <option value="verified" {if $system['groups_permission'] == "verified"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-check-circle fa-lg fa-fw'></i></div><div class='text'><b>{__("Verified Users")}</b><br>{__("Only Admins, Moderators, Pro and Verified Users")}</div></div>">{__("Verified Users")}</option>
                                    <option value="everyone" {if $system['groups_permission'] == "everyone"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-globe fa-lg fa-fw'></i></div><div class='text'><b>{__("Everyone")}</b><br>{__("Any user in the system can")}</div></div>">{__("Everyone")}</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control selectpicker" name="events_permission">
                                    <option value="admins" {if $system['events_permission'] == "admins"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-lock fa-lg fa-fw'></i></div><div class='text'><b>{__("Admins")}</b><br>{__("Only Admins and Moderators")}</div></div>">{__("Admins")}</option>
                                    <option value="pro" {if $system['events_permission'] == "pro"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-rocket fa-lg fa-fw'></i></div><div class='text'><b>{__("Pro Users")}</b><br>{__("Only Admins, Moderators and Pro Users")}</div></div>">{__("Pro Users")}</option>
                                    <option value="verified" {if $system['events_permission'] == "verified"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-check-circle fa-lg fa-fw'></i></div><div class='text'><b>{__("Verified Users")}</b><br>{__("Only Admins, Moderators, Pro and Verified Users")}</div></div>">{__("Verified Users")}</option>
                                    <option value="everyone" {if $system['events_permission'] == "everyone"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-globe fa-lg fa-fw'></i></div><div class='text'><b>{__("Everyone")}</b><br>{__("Any user in the system can")}</div></div>">{__("Everyone")}</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control selectpicker" name="blogs_permission">
                                    <option value="admins" {if $system['blogs_permission'] == "admins"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-lock fa-lg fa-fw'></i></div><div class='text'><b>{__("Admins")}</b><br>{__("Only Admins and Moderators")}</div></div>">{__("Admins")}</option>
                                    <option value="pro" {if $system['blogs_permission'] == "pro"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-rocket fa-lg fa-fw'></i></div><div class='text'><b>{__("Pro Users")}</b><br>{__("Only Admins, Moderators and Pro Users")}</div></div>">{__("Pro Users")}</option>
                                    <option value="verified" {if $system['blogs_permission'] == "verified"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-check-circle fa-lg fa-fw'></i></div><div class='text'><b>{__("Verified Users")}</b><br>{__("Only Admins, Moderators, Pro and Verified Users")}</div></div>">{__("Verified Users")}</option>
                                    <option value="everyone" {if $system['blogs_permission'] == "everyone"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-globe fa-lg fa-fw'></i></div><div class='text'><b>{__("Everyone")}</b><br>{__("Any user in the system can")}</div></div>">{__("Everyone")}</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control selectpicker" name="market_permission">
                                    <option value="admins" {if $system['market_permission'] == "admins"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-lock fa-lg fa-fw'></i></div><div class='text'><b>{__("Admins")}</b><br>{__("Only Admins and Moderators")}</div></div>">{__("Admins")}</option>
                                    <option value="pro" {if $system['market_permission'] == "pro"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-rocket fa-lg fa-fw'></i></div><div class='text'><b>{__("Pro Users")}</b><br>{__("Only Admins, Moderators and Pro Users")}</div></div>">{__("Pro Users")}</option>
                                    <option value="verified" {if $system['market_permission'] == "verified"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-check-circle fa-lg fa-fw'></i></div><div class='text'><b>{__("Verified Users")}</b><br>{__("Only Admins, Moderators, Pro and Verified Users")}</div></div>">{__("Verified Users")}</option>
                                    <option value="everyone" {if $system['market_permission'] == "everyone"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-globe fa-lg fa-fw'></i></div><div class='text'><b>{__("Everyone")}</b><br>{__("Any user in the system can")}</div></div>">{__("Everyone")}</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control selectpicker" name="forums_permission">
                                    <option value="admins" {if $system['forums_permission'] == "admins"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-lock fa-lg fa-fw'></i></div><div class='text'><b>{__("Admins")}</b><br>{__("Only Admins and Moderators")}</div></div>">{__("Admins")}</option>
                                    <option value="pro" {if $system['forums_permission'] == "pro"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-rocket fa-lg fa-fw'></i></div><div class='text'><b>{__("Pro Users")}</b><br>{__("Only Admins, Moderators and Pro Users")}</div></div>">{__("Pro Users")}</option>
                                    <option value="verified" {if $system['forums_permission'] == "verified"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-check-circle fa-lg fa-fw'></i></div><div class='text'><b>{__("Verified Users")}</b><br>{__("Only Admins, Moderators, Pro and Verified Users")}</div></div>">{__("Verified Users")}</option>
                                    <option value="everyone" {if $system['forums_permission'] == "everyone"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-globe fa-lg fa-fw'></i></div><div class='text'><b>{__("Everyone")}</b><br>{__("Any user in the system can")}</div></div>">{__("Everyone")}</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control selectpicker" name="movies_permission">
                                    <option value="admins" {if $system['movies_permission'] == "admins"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-lock fa-lg fa-fw'></i></div><div class='text'><b>{__("Admins")}</b><br>{__("Only Admins and Moderators")}</div></div>">{__("Admins")}</option>
                                    <option value="pro" {if $system['movies_permission'] == "pro"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-rocket fa-lg fa-fw'></i></div><div class='text'><b>{__("Pro Users")}</b><br>{__("Only Admins, Moderators and Pro Users")}</div></div>">{__("Pro Users")}</option>
                                    <option value="verified" {if $system['movies_permission'] == "verified"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-check-circle fa-lg fa-fw'></i></div><div class='text'><b>{__("Verified Users")}</b><br>{__("Only Admins, Moderators, Pro and Verified Users")}</div></div>">{__("Verified Users")}</option>
                                    <option value="everyone" {if $system['movies_permission'] == "everyone"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-globe fa-lg fa-fw'></i></div><div class='text'><b>{__("Everyone")}</b><br>{__("Any user in the system can")}</div></div>">{__("Everyone")}</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control selectpicker" name="games_permission">
                                    <option value="admins" {if $system['games_permission'] == "admins"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-lock fa-lg fa-fw'></i></div><div class='text'><b>{__("Admins")}</b><br>{__("Only Admins and Moderators")}</div></div>">{__("Admins")}</option>
                                    <option value="pro" {if $system['games_permission'] == "pro"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-rocket fa-lg fa-fw'></i></div><div class='text'><b>{__("Pro Users")}</b><br>{__("Only Admins, Moderators and Pro Users")}</div></div>">{__("Pro Users")}</option>
                                    <option value="verified" {if $system['games_permission'] == "verified"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-check-circle fa-lg fa-fw'></i></div><div class='text'><b>{__("Verified Users")}</b><br>{__("Only Admins, Moderators, Pro and Verified Users")}</div></div>">{__("Verified Users")}</option>
                                    <option value="everyone" {if $system['games_permission'] == "everyone"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-globe fa-lg fa-fw'></i></div><div class='text'><b>{__("Everyone")}</b><br>{__("Any user in the system can")}</div></div>">{__("Everyone")}</option>
                                </select>
                            </div>
                        </div>
            ...
            <div class="card-body">
                ...
                <div class="form-table-row">
                    ...
                    <div>
                        ...
                        <div class="form-text d-none d-sm-block">{__("Turn infinite scroll on mobile On and Off, Infinite scroll allowed by default on larger screens")}</div>
                    </div>
                    <div class="text-right">
            ...
            <div class="tab-pane active" id="General">
                <form class="js_ajax-forms " data-url="admin/settings.php?edit=registration">
                    <div class="card-body">
                        ...
                        <div class="form-table-row">
                            <div class="avatar">
                                {include file='__svg_icons.tpl' icon="invite_friend" width="40px" height="40px"}
                            </div>
                            <div>
                ...
                <div class="form-group form-row">
                    ...
                    <div class="col-md-9">
                        <select class="form-control selectpicker" name="live_permission">
                            <option value="admins" {if $system['live_permission'] == "admins"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-lock fa-lg fa-fw'></i></div><div class='text'><b>{__("Admins")}</b><br>{__("Only Admins and Moderators")}</div></div>">{__("Admins")}</option>
                            <option value="pro" {if $system['live_permission'] == "pro"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-rocket fa-lg fa-fw'></i></div><div class='text'><b>{__("Pro Users")}</b><br>{__("Only Admins, Moderators and Pro Users")}</div></div>">{__("Pro Users")}</option>
                            <option value="verified" {if $system['live_permission'] == "verified"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-check-circle fa-lg fa-fw'></i></div><div class='text'><b>{__("Verified Users")}</b><br>{__("Only Admins, Moderators, Pro and Verified Users")}</div></div>">{__("Verified Users")}</option>
                            <option value="everyone" {if $system['live_permission'] == "everyone"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-globe fa-lg fa-fw'></i></div><div class='text'><b>{__("Everyone")}</b><br>{__("Any user in the system can")}</div></div>">{__("Everyone")}</option>
                        </select>
                    </div>
                </div>
            ...
            <div class="tab-pane" id="Stripe">
                <form class="js_ajax-forms " data-url="admin/settings.php?edit=stripe">
                    <div class="card-body">
                        <div class="form-table-row">
                            <div class="avatar">
                                {include file='__svg_icons.tpl' icon="credit_card" width="40px" height="40px"}
                            </div>
                            <div>
