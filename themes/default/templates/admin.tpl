                ...
                <div class="card-body with-nav">
                    <ul class="side-nav">
                        ...
                        <li {if $view == "offers"}class="active"{/if}>
                            <a href="#offers" data-toggle="collapse" {if $view == "offers"}aria-expanded="true"{/if}>
                                <i class="fa fa-tag fa-fw mr10" style="color: #F44336"></i>{__("Offers")}
                            </a>
                        ...
                        <li {if $view == "jobs"}class="active"{/if}>
                            <a href="#jobs" data-toggle="collapse" {if $view == "jobs"}aria-expanded="true"{/if}>
                                <i class="fa fa-briefcase fa-fw mr10" style="color: #F44336"></i>{__("Jobs")}
                            </a>
                        ...
                        <li {if $view == "market"}class="active"{/if}>
                            <a href="#market" data-toggle="collapse" {if $view == "market"}aria-expanded="true"{/if}>
                                <i class="fa fa-shopping-bag fa-fw mr10" style="color: #F44336"></i>{__("Marketplace")}
                            </a>
