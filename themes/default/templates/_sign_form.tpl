<div class="card card-register" style="border-radius:25px;">
        ...
        <div class="card-body">
            ...
            <form class="js_ajax-forms" data-url="core/signin.php">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="password" class="form-control" placeholder='{__("Kata sandi")}' name="password" required>
                    </div>
                </div>
                <div class="custom-control custom-checkbox mb10">
                    <input type="checkbox" class="custom-control-input" name="remember" id="remember">
                    <label class="custom-control-label" for="remember">{__("Ingatkan saya")}</label>
                    <a class="float-right" href="{$system['system_url']}/reset">{__("Lupa sandi?")}</a>
                </div>
                <div class="form-group">
                    <button type="submit" class="btn btn-block btn-primary bg-gradient-blue border-0 rounded-pill">{__("Masuk")}</button>
                </div>
                <!-- error -->
            ...
            {if $system['registration_enabled'] || (!$system['registration_enabled'] && $system['invitation_enabled'])}
                <div class="mt20 text-center">
                    {__("Belum mendaftar?")} <a href="{$system['system_url']}/signup" class="js_toggle-panel text-link">{__("Buat akun")}</a>
                </div>
            {/if}
        </div>
    </div>
    ...
    <div class="js_panel {if $do != 'up'}x-hidden{/if}">
        ...
        <div class="card-body">
            <form class="js_ajax-forms" data-url="core/signup.php">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input name="first_name" type="text" class="form-control" placeholder='{__("Nama Depan")}' required>
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input name="last_name" type="text" class="form-control" placeholder='{__("Nama Belakang")}' required>
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                ...
                <div class="form-group">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input name="password" type="password" class="form-control" placeholder='{__("Kata Sandi")}' required>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <select name="gender" id="gender" class="form-control" required>
                                <option value="none">{__("Pilih Jenis Kelamin")}:</option>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <select class="form-control" name="birth_month">
                                        <option value="none">{__("Bulan")}</option>
                                ...
                                <div class="col">
                                    <select class="form-control" name="birth_day">
                                        <option value="none">{__("Tanggal")}</option>
                                        {for $i=1 to 31}
                                ...
                                <div class="col">
                                    <select class="form-control" name="birth_year">
                                        <option value="none">{__("Tahun")}</option>
                                        {for $i=1905 to 2017}
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-block btn-success bg-gradient-green border-0 rounded-pill">{__("Daftar")}</button>
                </div>
                <!-- error -->
                <div class="alert alert-danger mb0 x-hidden"></div>
                <!-- error -->
            ...
            {/if}
            <div class="mt20 text-center">
                {__("Sudah mendaftar?")} <a href="{$system['system_url']}/signin" class="js_toggle-panel text-link">{__("Masuk Sekarang")}</a>
            </div>
        </div>
    </div>
    <!-- signup -->
