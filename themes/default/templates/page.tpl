                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="about-list">
                                    ...
                                    <div class="publisher-tools-tab link js_publisher-tab" style="background:none;" data-tab="job" data-toggle="modal" data-url="posts/job.php?do=create&amp;page_id={$spage['page_id']}"> <div class="svg-container mr5" style="width:24px; height:24px; "> <!--?xml version="1.0" encoding="iso-8859-1"?--> <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 468.293 468.293" style="enable-background:new 0 0 468.293 468.293;" xml:space="preserve"> <path style="fill:#3B566A;" d="M287.838,22.426h-18.094c-1.702-4.891-6.304-8.424-11.776-8.424h-47.645
                ...
                {elseif $view == "settings"}
                                ...
                                <ul class="side-nav">
                                    <li {if $sub_view == ""}class="active"{/if}>
                                        <a href="{$system['system_url']}/pages/{$spage['page_name']}/settings">
                                            <i class="fa fa-cog fa-fw mr10"></i>{__("Institution Settings")}
                                        </a>
                                    </li>
                                    <li {if $sub_view == "info"}class="active"{/if}>
                                        <a href="{$system['system_url']}/pages/{$spage['page_name']}/settings/info">
                                            <i class="fa fa-info-circle fa-fw mr10"></i>{__("Institution Information")}
                                        </a>
                                    </li>
                    ...
                    <div class="col-lg-9">
                        <div class="card">
                            {if $sub_view == ""}
                                <div class="card-header with-icon">
                                    <i class="fa fa-cog mr10"></i>{__("Institution Settings")}
                                </div>
