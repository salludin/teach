            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="stat-panel bg-gradient-primary">
                        <div class="stat-cell">
                            ...
                            <span class="text-xxlg">{$system['system_currency_symbol']}{$total_earnings|number_format:2}</span><br>
                ...
                <div class="col-sm-6">
                    <div class="stat-panel bg-gradient-info">
                        <div class="stat-cell">
                            <i class="fa fa-dollar-sign bg-icon"></i>
                            <span class="text-xxlg">{$system['system_currency_symbol']}{$month_earnings|number_format:2}</span><br>
