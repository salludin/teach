                                    ...
                                    <ul class="clearfix">
                                                    ...
                                                    {if $system['system_theme_mode_select']}
                                                        {if $system['theme_mode_night']}
                                                            <div class="dropdown-item pointer js_theme-mode" data-mode="day">
                                                                <span class="js_theme-mode-text">{__("Mode siang")}</span>
                                                                <span class="float-right">
                                                        ...
                                                        {else}
                                                            <div class="dropdown-item pointer js_theme-mode" data-mode="night">
                                                                <span class="js_theme-mode-text">{__("Mode malam")}</span>
                                                                <span class="float-right">
                                        ...
                                        {else}
                                            ...
                                            <li class="dropdown float-right">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="{$system['system_url']}/signin">{__("Masuk")}</a>
                                                    {if $system['registration_enabled'] || (!$system['registration_enabled'] && $system['invitation_enabled'])}
                                                        <a class="dropdown-item" href="{$system['system_url']}/signup">{__("Gabung")}</a>
                                        <a class="dropdown-item" href="{$system['system_url']}/signup_institution">{__("Gabung Institusi")}</a>
                                                    {/if}
                                                    {if $system['system_theme_mode_select']}
                                                        <div class="dropdown-divider"></div>
                                                        {if $system['theme_mode_night']}
