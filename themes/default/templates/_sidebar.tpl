<div class="card main-side-nav-card">
    <div class="card-body with-nav">
        <ul class="main-side-nav">
            ...
            {if $system['blogs_enabled'] && $user->_data['can_write_articles']}
            ...
            {if $system['market_enabled'] && $user->_data['can_sell_products']}
            ...
            <!-- advertising -->
            {if $system['ads_enabled'] || $system['wallet_enabled'] || $system['packages_enabled']}
                <li class="ptb5">
