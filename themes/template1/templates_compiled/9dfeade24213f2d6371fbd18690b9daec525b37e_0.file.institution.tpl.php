<?php
/* Smarty version 3.1.34-dev-7, created on 2020-07-29 08:59:40
  from '/home/u6574599/public_html/content/themes/default/templates/institution.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5f213a7c795917_69315696',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9dfeade24213f2d6371fbd18690b9daec525b37e' => 
    array (
      0 => '/home/u6574599/public_html/content/themes/default/templates/institution.tpl',
      1 => 1592184298,
      2 => 'file',
    ),
  ),
...
function content_5f213a7c795917_69315696 (Smarty_Internal_Template $_smarty_tpl) {
...
/institution/<?php echo $_smarty_tpl->tpl_vars['profile']->value['user_name'];?>
...
" <?php if ($_smarty_tpl->tpl_vars['view']->value == '') {?>class="active"<?php }?>>
                        ...
                        <li>
                            <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/institution/<?php echo $_smarty_tpl->tpl_vars['profile']->value['user_name'];?>
/jobs" <?php if ($_smarty_tpl->tpl_vars['view']->value == "jobs") {?>class="active"<?php }?>>
                                <i class="fa fa-briefcase  fa-fw mr5"></i><?php echo __("Job Posting");?>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb5">
                                        <?php if (!$_smarty_tpl->tpl_vars['profile']->value['user_biography']) {?>
                                            <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/settings/profile">
                                                <i class="fas fa-plus-circle mr5"></i><?php echo __("Add your overview");?>

                                            </a>
                                        <?php } else { ?>
                                            <i class="fas fa-check-circle green mr5"></i>
                                            <span style="text-decoration: line-through;"><?php echo __("Add your overview");?>
</span>
                                        <?php }?>
                                    </div>
                                    <div class="mb5">
                                        <?php if (!$_smarty_tpl->tpl_vars['profile']->value['user_website']) {?>
                                            <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/settings/profile">
                                                <i class="fas fa-plus-circle mr5"></i><?php echo __("Add your website");?>

                                            </a>
                                        <?php } else { ?>
                                            <i class="fas fa-check-circle green mr5"></i>
                                            <span style="text-decoration: line-through;"><?php echo __("Add your website");?>
</span>
                                        <?php }?>
                                    </div>
                                    <div class="mb5">
                                        <?php if (!$_smarty_tpl->tpl_vars['profile']->value['user_address'] || !$_smarty_tpl->tpl_vars['profile']->value['postal_code'] || !$_smarty_tpl->tpl_vars['profile']->value['user_current_city']) {?>
                                            <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                    ...
                    <!-- center panel -->
                    <div class="order-3 <?php if ($_smarty_tpl->tpl_vars['user']->value->_data['user_id'] == $_smarty_tpl->tpl_vars['profile']->value['user_id']) {?>col-lg-6<?php } else { ?>col-lg-9<?php }?> order-lg-2">
                        <!-- panel [about] -->
                        <div class="card">
                            <div class="card-body">
 ...
 <span class="text-info"><?php echo $_smarty_tpl->tpl_vars['profile']->value['user_hometown'];?>
                                    ...
                                    <li>
                                        <div class="about-list-item">
                                                ...
                                                <?php echo $_smarty_tpl->tpl_vars['profile']->value['id_industry'];?>
