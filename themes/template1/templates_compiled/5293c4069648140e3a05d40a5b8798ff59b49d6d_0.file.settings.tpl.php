<?php
/* Smarty version 3.1.34-dev-7, created on 2020-07-30 04:25:04
  from '/home/u6574599/public_html/content/themes/default/templates/settings.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5f224ba0460918_69717087',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5293c4069648140e3a05d40a5b8798ff59b49d6d' => 
    array (
      0 => '/home/u6574599/public_html/content/themes/default/templates/settings.tpl',
      1 => 1596083103,
      2 => 'file',
    ),
  ),
...
function content_5f224ba0460918_69717087 (Smarty_Internal_Template $_smarty_tpl) {
...
/settings/profile/design">
                        ...
                        <?php if (!$_smarty_tpl->tpl_vars['user']->value->_is_company) {?>
                        <li <?php if ($_smarty_tpl->tpl_vars['view']->value == "cv") {?>class="active"<?php }?>>
                                <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/settings/cv">
                                    <i class="fa fa-id-card fa-fw mr10" style="color: #f44336;"></i>Curriculum Vitae
                                </a>
                            </li>
                        <?php }?>
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['sub_view']->value == '') {?>
                        <div class="card-header with-icon">
                            ...
                            <div class="float-right">
                                <a target="_blank" href="<?php if (!$_smarty_tpl->tpl_vars['user']->value->_is_company) {
echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/<?php } else {
echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/institution/<?php }
echo $_smarty_tpl->tpl_vars['user']->value->_data['user_name'];?>
" class="btn btn-sm btn-info">
                                    <i class="fa fa-tv"></i><span class="ml5 d-none d-lg-inline-block"><?php echo __("View Profile");?>
</span>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label class="form-control-label"><?php if (!$_smarty_tpl->tpl_vars['user']->value->_is_company) {
echo __("First Name");
} else {
echo __("Institution Name");
}?></label>
...
">
                                ...
                                <div class="form-group" style="display:none;">
                                    <label class="form-control-label"><?php echo __("Latitude");?>
</label>
                                    <input type="text" class="form-control js_geocomplete" id="latitude" name="lat" value="<?php echo $_smarty_tpl->tpl_vars['user']->value->_data['user_latitude'];?>
">
                                </div>
                                
                                <div class="form-group" style="display:none;">
                                    <label class="form-control-label"><?php echo __("Longitude");?>
</label>
                                    <input type="text" class="form-control js_geocomplete" id="longitude" name="lng" value="<?php echo $_smarty_tpl->tpl_vars['user']->value->_data['user_longitude'];?>
">
                                </div>                                
...
1</strong>.
 ...
 <strong><?php if ($_smarty_tpl->tpl_vars['system']->value['packages_enabled'] && $_smarty_tpl->tpl_vars['user']->value->_data['user_subscribed']) {
...
, <?php echo __("You have");?>
 <strong><?php echo $_smarty_tpl->tpl_vars['remaining_points']->value;?>
</strong> <?php echo __("remaining points");?>
...
$__foreach_transaction_5_saved = $_smarty_tpl->tpl_vars['transaction'];
?>
                                                <tr>
...
"><?php echo $_smarty_tpl->tpl_vars['transaction']->value['last_update'];?>
                                            ...
                                            <?php
$_smarty_tpl->tpl_vars['transaction'] = $__foreach_transaction_5_saved;
}
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                        </tbody>
...
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['transfer']->value) {
$_smarty_tpl->tpl_vars['transfer']->iteration++;
$__foreach_transfer_6_saved = $_smarty_tpl->tpl_vars['transfer'];
?>
                                                <tr>
...
"><?php echo $_smarty_tpl->tpl_vars['transfer']->value['time'];?>
                                            ...
                                            <?php
$_smarty_tpl->tpl_vars['transfer'] = $__foreach_transfer_6_saved;
}
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                        </tbody>
...
$__foreach_app_8_saved = $_smarty_tpl->tpl_vars['app'];
?>
...
">
                            ...
                            <?php
$_smarty_tpl->tpl_vars['app'] = $__foreach_app_8_saved;
}
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                        <?php } else { ?>
                 ...
                 <?php } elseif ($_smarty_tpl->tpl_vars['view']->value == "cv") {?>
                    <div class="card-header with-icon">
                        <i class="fa fa-id-card fa-fw mr10" style="color: #f44336;"></i><?php echo __("Curriculum Vitae");?>
...
"<?php }?>>
                        ...
                        <div class="card-header">
                            ...
                            <!-- post attachments -->
                            <div class="publisher-attachments"></div>
                            <!-- post attachments -->
                                ...
                                <ul class="row">
                                        <li class="col-md-6">
                                            <div class="publisher-tools-tab attach js_publisher-tab" data-tab="file">
                                                <img src="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/content/themes/<?php echo $_smarty_tpl->tpl_vars['system']->value['theme'];?>
/images/icons/publisher/folder.png" class="js_x-uploader" data-handle="cv"  data-type="file"><?php echo __("Upload File");?>
