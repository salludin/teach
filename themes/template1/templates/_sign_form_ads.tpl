<div class="card card-register">
    ...
    <!-- signin -->
    <div class="js_panel {if $do == 'upads'}x-hidden{/if}">
    ...
    <div class="js_panel {if $do != 'upads'}x-hidden{/if}">
        ...
        <div class="card-body">
            <form class="js_ajax-forms" data-url="core/signup_ads.php">
                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-prepend">
                ...
                <div class="form-group">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <textarea class="form-control" row="8" placeholder='{__("Address")}' name="address" required></textarea>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input name="person" class="form-control" placeholder='{__("Person in Charge")}' required>
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                ...
                <div class="form-group">
                    <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-address-book fa-fw"></i></span>
                            </div>
                            <textarea class="form-control" row="15" placeholder='{__("Description of your Company")}' name="description" required></textarea>
                        </div>
                    </div>
                </div>
