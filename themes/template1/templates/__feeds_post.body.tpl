...
{if $_post['post_type'] == "product"}
    ...
    {if $_post['author_id'] != $user->_data['user_id'] }
        <div class="mt10 clearfix" style="margin-bottom:25px;">
            <button class="btn btn-sm btn-danger" id="pay-button">{__("Buy")}</button>
...
<script src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="SB-Mid-client-kSnLJ45nSegi7XpJ"></script>
<script type="text/javascript">
  document.getElementById('pay-button').onclick = function(){
    ...
    {
      transaction_details: {
        gross_amount: {$_post['product']['price']},
