	...
	switch ($_GET['view']) {
		case '':
			...
			if($profile['user_id'] == $user->_data['user_id']) {
				...
				/* [4] check address postal code & location */
            ...
            // get industries
			$industries = $user->get_industries();
			/* get posts */
