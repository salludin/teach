...
(5, 'system_description', 'Sngine is a Social Network Platform is the best way to create your own social website or online community, Launch it in just 1 minute with ultimate features, Sngine is fast, secured, and it will be regularly updated.'),
(6, 'system_keywords', 'php social network, php social platform, sngine, sngine v2, social network, social network platform, Social network Script, social platform'),
(7, 'system_email', ''),
...
<html lang="en">
    <head>
        ...
        <title>Sngine &rsaquo; Installer (v<?php echo SYS_VER ?>)</title>
        <link rel="shortcut icon" href="includes/assets/js/sngine/installer/favicon.png" />
        ...
        <link rel="stylesheet" href="includes/assets/js/sngine/installer/wizard.css">
    </head>
    <body>
        <main class="my-5">
            <div class="container">
                <form id="wizard" method="post" class="position-relative">
                    ...
                    <section>
                        <div class="content-wrapper">
                            ...
                            <p>
                                Welcome to <strong>Sngine</strong> installation process! Just fill in the required
        ...
        <script src="includes/assets/js/sngine/installer/jquery.steps.min.js"></script>
